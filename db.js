...
const PRODUCT_CACHE_KEY = "perfumeDB_BestProducts_Catalog_Data_V12";
const PRODUCT_TIME_KEY = "perfumeDB_BestProducts_Catalog_Time_V12";
const PRODUCT_FALLBACK_KEY = "perfumeDB_BestProducts_Catalog_Last_Valid_Data_V12";
